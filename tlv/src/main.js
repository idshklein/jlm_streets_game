...
// City-scoped cookie keys — only visible to pages under /tlv/
const COOKIE_CONSENT_KEY = "tlv_score_cookie_consent";
const COOKIE_SCORE_KEY = "tlv_score";
const COOKIE_FOUND_CODES_KEY = "tlv_found_codes";
const COOKIE_PATH = "/tlv/";
